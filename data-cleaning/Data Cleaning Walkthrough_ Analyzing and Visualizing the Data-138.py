...
m.scatter(longitudes,latitudes,latlon=True,s=20,zorder=2)
...
m.scatter(longitudes,latitudes,latlon=True,s=20,zorder=2,c=combined['ell_percent'],cmap='summer')
...
import numpy
combined_group = combined.groupby('school_dist')
districts = combined_group.agg(numpy.mean)
...
m.scatter(longitudes,latitudes,latlon=True,s=50,zorder=2,c=districts['ell_percent'],cmap='summer')
