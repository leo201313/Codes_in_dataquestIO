...
for interation_varible in content_ratings:
    content_ratings[interation_varible] = (content_ratings[interation_varible] / total_number_of_apps) * 100
...
rating_count_dictionary = {'0-100W':0, '100W-200W':0, '200W-300W':0}
for row in apps_data[1:]:
    ratings = int(row[5])
    if 0 <= ratings < 1000000:
        rating_count_dictionary['0-100W'] += 1
    elif 1000000 <= ratings < 2000000:
        rating_count_dictionary['100W-200W'] += 1
    else:
        rating_count_dictionary['200W-300W'] += 1
print(rating_count_dictionary)
